...
export interface ApiServiceRequestServiceRequest
  ...
  attributes: {
    ...
    customer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    customer_lat: Schema.Attribute.Decimal;
    customer_lng: Schema.Attribute.Decimal;
    ...
    photos: Schema.Attribute.Media<
      ...
      true
    >;
    preferred_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    provider_lat: Schema.Attribute.Decimal;
    provider_lng: Schema.Attribute.Float;
    publishedAt: Schema.Attribute.DateTime;
    reviews: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pending'>;
    suggested_budget: Schema.Attribute.BigInteger & Schema.Attribute.Required;
